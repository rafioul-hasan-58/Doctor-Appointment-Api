...
router.post('/', (0, auth_1.default)(['doctor']), (0, validateRequest_1.default)(service_validation_1.serviceValidationSchema), service_controller_1.serviceController.addDoctorService);
